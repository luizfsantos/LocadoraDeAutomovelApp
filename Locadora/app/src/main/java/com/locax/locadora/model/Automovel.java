...
public class Automovel implements Comparable<Automovel>, Serializable {
    ...
    private String nomeImagem;			//Variavel responsável por guardar o nome da imagem
    ...
    public Automovel(String chassi, String modelo, String fabricante,double tarifaLivre, double controladoInicial, double controladoKm, String nomeImagem){
        this.chassi = chassi;
        this.modelo = modelo;
        this.fabricante = fabricante;
        this.tarifaLivre = tarifaLivre;
    ...
    public Automovel( String modelo, String fabricante,double tarifaLivre, double controladoInicial, double controladoKm, String nomeImagem){
        ...
        public Automovel(long id)				{idAutomovel = id;}


    public long getIdAutomovel()			{return idAutomovel;}
    ...
    public int getNagadorGps()				{return nagadorGps;}



    public int getCadeiraBebe()				{return cadeiraBebe;}



    public int getMotorista()				{return motorista;}



    public double getTarifaLivre()				{return tarifaLivre;}



    public double getControladoInicial()		{return controladoInicial;}

    public void setControladoKm(double tarkm)	{controladoKm = tarkm;}
